...
public class AddAuctionScreen extends JFrame {

    public AddAuctionScreen() {
        setTitle("AuctionHub — Add Auction");
        setSize(420, 520);
        ...
        JLabel sub = new JLabel("Start a new auction");
        ...
        JLabel title = new JLabel("New Auction 🔨");
        ...
        RoundedButton addBtn = new RoundedButton("Start Auction",
        ...
        card.add(priceField);
        card.add(Box.createVerticalStrut(12));
        card.add(makeLabel("Duration (hours)"));
        card.add(Box.createVerticalStrut(4));
        card.add(hoursField);
        ...
        addBtn.addActionListener(e -> {
            ...
            try {
                ...
                Marketplace.getInstance().addAuctionProduct(name, price, hours);
                JOptionPane.showMessageDialog(this,
                        "Auction for " + name + " started!", "Success",
                        JOptionPane.INFORMATION_MESSAGE);
                dispose();
                new MainScreen().setVisible(true);
            } catch (NumberFormatException ex) {
                errorLabel.setText("Price and hours must be numbers.");
            }
        });
